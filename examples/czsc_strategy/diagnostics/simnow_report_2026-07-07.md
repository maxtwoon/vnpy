...
- observed_days: `10/20`
- valid_observation_days: `6/20`
- pass_days: `6`
- pending_days: `3`
- skipped_days: `1`
- consistency_matched_days: `6`
- warning_days: `0`
- halt_days: `0`
...
- promotion_blockers: `need_14_more_valid_observation_days, pending_days_present, skipped_days_present, non_pass_days_present, consistency_not_fully_matched`
...
|---|---|---|---|---|---|
| 2026-06-22 | pending | event_surface_mismatch | medium | SimNow live capture 与 replay 事件面不一致；建议核对 strategy event surface 与 raw account surface 的对比规则。 | False |
| 2026-06-27 | skipped | ctp_disconnect_097_no_snapshot | info | CTP 连接失败；建议检查 SimNow 服务、网络、账号状态。 | False |
| 2026-06-29 | pending | event_surface_mismatch | medium | SimNow live capture 与 replay 事件面不一致；建议核对 strategy event surface 与 raw account surface 的对比规则。 | False |
...
|---|---|---|---|---|---|---|---:|---:|---:|---|---|---|---:|---:|---:|---:|
| 2026-06-22 | False | pending | event_surface_mismatch | False | pass | unknown | 0 | 0 | 0 |  |  |  | 0.00% | 0.00% | 0.00% | 0.00% |
| 2026-06-27 | False | skipped | ctp_disconnect_097_no_snapshot | False | pass |  | 0 | 0 | 0 |  |  |  | 0.00% | 0.00% | 0.00% | 0.00% |
| 2026-06-29 | False | pending | event_surface_mismatch | False | pass | unknown | 0 | 2 | 2 |  |  |  | 0.00% | 0.00% | 0.00% | 0.00% |
