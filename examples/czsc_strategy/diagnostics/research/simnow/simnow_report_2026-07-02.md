...
- last_valid_observation_date: `2026-07-06`
- consecutive_clean_days: `0`
- ready_to_expand: `False`
- promotion_blockers: `need_18_more_valid_observation_days, pending_days_present, skipped_days_present, non_pass_days_present, consistency_not_fully_matched`
...
| 2026-07-03 | pending | historical_db_lag | medium | 历史 DB 未覆盖当天；建议等待或执行 backfill。 | False |
| 2026-07-06 | pass | no_actionable_events_on_either_side | ok | 计入 20 日有效观察。 | True |
| 2026-07-07 | pending | historical_db_lag | medium | 历史 DB 未覆盖当天；建议等待或执行 backfill。 | False |
| 2026-07-08 | pending | historical_db_lag | medium | 历史 DB 未覆盖当天；建议等待或执行 backfill。 | False |
...
| 2026-07-03 | False | pending | historical_db_lag | False | pass | pass | 0 | 0 | 0 |  |  |  | 0.00% | 0.00% | 0.00% | 0.00% |
| 2026-07-06 | True | pass | no_actionable_events_on_either_side | True | pass | pass | 0 | 0 | 0 |  |  |  | 0.00% | 0.00% | 0.00% | 0.00% |
| 2026-07-07 | False | pending | historical_db_lag | False | pass | pass | 0 | 2 | 2 |  |  |  | 0.00% | 0.00% | 0.00% | 0.00% |
| 2026-07-08 | False | pending | historical_db_lag | False | pass | pass | 0 | 0 | 0 |  |  |  | 0.00% | 0.00% | 0.00% | 0.00% |
