...
当日未产生有效市场数据，不计入 20 日观察；这不是代码失败，CTP 连接失败；建议检查 SimNow 服务、网络、账号状态。

## 下一步

按 automation_action 执行：no valid market data / rerun next valid session。
