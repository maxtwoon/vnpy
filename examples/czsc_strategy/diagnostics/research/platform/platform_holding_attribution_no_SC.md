...
- set: `no_SC`
- symbols: `AP888, RB888, A888, ZN888`
...
|---|---:|---:|---:|---:|---:|---:|
| all | 56 | 45.31% | 62.50% | 0.81% | 2.15 | 161.98 |
...
| RB888 | 14 | 3.37% | 64.29% | 0.24% | 1.34 | 64.00 |
...
| group | trades | pnl_sum | win_rate | avg_pnl | PF | avg_bars |
|---|---:|---:|---:|---:|---:|---:|
| 一买多头 | 37 | 10.38% | 54.05% | 0.28% | 1.41 | 94.32 |
| 三买多头 | 10 | 13.48% | 80.00% | 1.35% | 2.81 | 226.40 |
...
| group | trades | pnl_sum | win_rate | avg_pnl | PF | avg_bars |
|---|---:|---:|---:|---:|---:|---:|
| signal_exit | 15 | -3.86% | 40.00% | -0.26% | 0.44 | 116.33 |
| stop_loss | 12 | -32.63% | 0.00% | -2.72% | 0.00 | 144.75 |
| timeout | 1 | 1.36% | 100.00% | 1.36% | inf | 1,000.00 |
| trailing_stop | 28 | 80.44% | 100.00% | 2.87% | inf | 163.89 |

## by_duration

| group | trades | pnl_sum | win_rate | avg_pnl | PF | avg_bars |
|---|---:|---:|---:|---:|---:|---:|
| 00-20 | 4 | -5.43% | 25.00% | -1.36% | 0.32 | 15.25 |
| 061-120 | 15 | -2.53% | 40.00% | -0.17% | 0.80 | 89.07 |
| 121-300 | 10 | 26.60% | 80.00% | 2.66% | 19.10 | 193.80 |
| 21-60 | 19 | 14.50% | 73.68% | 0.76% | 2.43 | 37.68 |
...
| bars_gt_120_win | 14 | 47.38% | 100.00% | 3.38% | inf | 375.00 |
| bars_le_120 | 38 | 6.54% | 55.26% | 0.17% | 1.21 | 55.61 |
...
| RB888 | 三买多头 | 2025-12-08 09:29:00 | 2026-01-07 22:59:00 | 1.44% | 248 | 移动止损 |
